...
const getMobileConfig = (originalConfig) => {
  if (isMobile()) {
    return {
      ...originalConfig,
      duration: Math.max((originalConfig.duration || 0.6) * 2, 1.2), // Much slower animations on mobile for smooth effect
      delay: (originalConfig.delay || 0) * 0.8 // Keep delays reasonable
    };
  }
